...
const suppliedGuideUrl = "/manus-storage/FacilitatorsGuideandChecklist_7e086423.pdf";
const printableGuideUrl = "/manus-storage/FacilitatorsGuideandChecklist_7e086423.pdf";
  ...
  const renderHome = () => (
    <>
      ...
      <section className="downloads-banner" style={{ backgroundImage: `linear-gradient(rgba(247,242,232,.88), rgba(247,242,232,.88)), url(${planningTextureUrl})` }}>
        ...
        <div className="download-actions"><a href={printableGuideUrl} target="_blank" rel="noreferrer"><Download size={17} /> Facilitator guide &amp; checklist</a><button onClick={downloadChecklistPdf}><Download size={17} /> Checklist</button></div>
      </section>
    </>
  );
