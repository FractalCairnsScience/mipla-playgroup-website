...
const printableGuideUrl = "/manus-storage/main_4dad1239.pdf";
...
export default function Home() {
  ...
  const taleBotExplainer = () => (
    <a className="tale-bot-explainer" href={taleBotExplainerUrl} target="_blank" rel="noreferrer" aria-label="Launch the Tale Bot explainer video in a new tab">
      <div className="tale-bot-thumbnail"><img src={taleBotThumbnailUrl} alt="Tale Bot and programmable robot on a colourful learning mat" /><span className="tale-bot-play"><Play size={24} fill="currentColor" aria-hidden="true" /></span></div>
      <div className="tale-bot-copy"><p className="eyebrow"><span /> Watch and prepare</p><h2>Tale Bot explainer</h2><p>A short video introduction to using Tale Bot in a supported Digital Play session.</p><span className="tale-bot-launch"><Play size={16} fill="currentColor" aria-hidden="true" /> Click to launch</span></div>
    </a>
  );
