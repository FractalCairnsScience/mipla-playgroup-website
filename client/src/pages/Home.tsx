 ...
 * Reef Current teal, tide contours, and document-like tools keep planning central.
 */
...
type ToolkitTab = "structure" | "setup" | "checklist";
  ...
  const renderToolkit = () => (
    <section className="page-frame toolkit-page">
      ...
      <div className="tab-row" role="tablist">
        {(["structure", "setup", "checklist"] as ToolkitTab[]).map((tab) => <button key={tab} className={toolkitTab === tab ? "active" : ""} onClick={() => setToolkitTab(tab)}>{tab === "structure" ? "Session rhythm" : tab === "setup" ? "Setting up" : "Checklist"}</button>)}
      </div>
