...
#let report-accent = rgb("#069fc5")
#let report-teal = rgb("#139fa2")
#let report-purple = rgb("#8b2799")
#let report-sunshine = rgb("#ffbf16")
...
#let partner-footer(show-page: true) = context {
  ...
  grid(
    ...
    align: center,
    [],
    image("brand-assets/jcu-logo.jpg", height: 0.73cm),
    image("brand-assets/lowitja-logo.jpg", height: 0.73cm),
    image("brand-assets/starlight-logo.jpg", height: 0.73cm),
      ...
      context {
        if counter(page).get().first() > 0 {
          ...
          grid(
            ...
            align(left)[#image("brand-assets/mura-kosker-logo.png", width: 0.58cm)],
            align(left)[#title],
            align(right)[#author],
          )
          v(-0.6em)
