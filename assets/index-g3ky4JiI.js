(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(s){if(s.ep)return;s.ep=!0;const l=t(s);fetch(s.href,l)}})();function S(e){e.innerHTML=`
    ...
    <div class="info-banner">
      <h3>About the Parent-Talk Model</h3>
      <p>The Mipla Playgroup is based on the Parent-Talk model developed for Torres Strait Islander communities. It combines playgroup with parent education, cultural connection, and community support — creating a space where children thrive and families grow stronger together.</p>
    </div>
  `,e.querySelectorAll("[data-nav]").forEach(i=>{i.addEventListener("click",()=>{const t=i.getAttribute("data-nav");t&&T(t)})})}function A(e){e.innerHTML=`
    ...
    <div class="accordion">
      <div class="acc-item open">
        ...
        <div class="acc-body">
          ...
          <img src="/images/content/002.webp" alt="Playgroup session" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/content/003.webp" alt="Children playing" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/content/004.webp" alt="Community playgroup" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/content/005.webp" alt="Playgroup models" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/content/006.webp" alt="Types of play" class="content-img" />
        </div>
      </div>
    </div>
  `,e.querySelectorAll(".acc-header").forEach(i=>{i.addEventListener("click",()=>{const t=i.closest(".acc-item"),a=t.querySelector(".acc-body"),s=i.querySelector(".acc-icon"),l=t.classList.contains("open");t.classList.toggle("open",!l),a.style.display=l?"none":"block",s.textContent=l?"▼":"▲"})})}function x(e){var i;e.innerHTML=`
    ...
    <div id="tab-structure" class="tab-content">
      ...
      <img src="/images/content/007.webp" alt="Session structure" class="content-img" />
    </div>
  ...
  `,e.querySelectorAll(".tab-btn").forEach(t=>{t.addEventListener("click",()=>{e.querySelectorAll(".tab-btn").forEach(s=>s.classList.remove("active")),t.classList.add("active");const a=t.getAttribute("data-tab");e.querySelectorAll(".tab-content").forEach(s=>{s.style.display=s.id===`tab-${a}`?"block":"none"})})}),e.querySelectorAll('input[type="checkbox"]').forEach(t=>{const a=t,s=`mipla_check_${a.getAttribute("data-check")}`;a.checked=localStorage.getItem(s)==="true",a.addEventListener("change",()=>localStorage.setItem(s,String(a.checked)))}),(i=e.querySelector("#reset-checklists"))==null||i.addEventListener("click",()=>{confirm("Reset all checklists?")&&e.querySelectorAll('input[type="checkbox"]').forEach(t=>{const a=t;a.checked=!1,localStorage.removeItem(`mipla_check_${a.getAttribute("data-check")}`)})})}const h=[{id:"c1",name:"Head and Shoulders (Local Language)",description:"Sing 'Head and Shoulders, Knees and Toes' in Torres Strait Islander language, touching body parts.",playType:"organised",developmentalFocus:["speech","motor","cognitive"],isCultural:!0,materials:["None required"],instructions:["Gather children in a circle","Teach the song in local language","Demonstrate body movements","Sing together while touching body parts","Repeat, gradually increasing speed"],ageRange:"1-4 years",duration:10},{id:"c2",name:"Traditional Weaving",description:"Introduce children to basic weaving using local materials such as palm fronds.",playType:"organised",developmentalFocus:["motor","cognitive","social"],isCultural:!0,materials:["Palm fronds","Pandanus leaves","Other local weaving materials"],instructions:["Show examples of traditional woven items","Demonstrate simple over-under weaving","Provide pre-cut materials for safety","Guide children through basic weaving","Encourage children to help each other"],ageRange:"3-4 years",duration:20},{id:"c3",name:"Making Musical Instruments",description:"Create simple traditional instruments using natural and recycled materials.",playType:"organised",developmentalFocus:["motor","cognitive","social"],isCultural:!0,materials:["Empty containers","Dried seeds or beans","Sticks","Shells","String"],instructions:["Show examples of traditional instruments","Fill containers with seeds to make shakers","Tie shells to string for ankle rattles","Decorate with natural materials","Play together as a group"],ageRange:"2-4 years",duration:25},{id:"c4",name:"Local Storytelling",description:"Share traditional stories from Torres Strait Islander culture with expressive voice and props.",playType:"organised",developmentalFocus:["speech","cognitive","social","emotional"],isCultural:!0,materials:["Picture books or visual aids","Cushions for sitting"],instructions:["Gather children in a comfortable circle","Use animated voice and gestures","Show pictures or props","Ask simple questions about the story","Encourage children to share thoughts"],ageRange:"2-4 years",duration:15},{id:"c5",name:"Traditional Dance and Movement",description:"Teach simple traditional dance movements and rhythms from Torres Strait culture.",playType:"organised",developmentalFocus:["motor","social","cognitive"],isCultural:!0,materials:["Music player (optional)","Open space"],instructions:["Demonstrate basic traditional dance movements","Start with simple foot patterns","Add arm movements gradually","Practice to traditional music or singing","Encourage children to move together"],ageRange:"2-4 years",duration:15},{id:"o1",name:"Welcome Song Circle",description:"Start the session with a welcoming song to help children feel comfortable and included.",playType:"organised",developmentalFocus:["social","emotional","speech"],isCultural:!1,materials:["None required"],instructions:["Sit in a circle with all children","Sing a simple welcome song","Say each child's name during the song","Encourage children to wave or clap","Repeat to build familiarity"],ageRange:"0-4 years",duration:5},{id:"o2",name:"Finger Painting",description:"Explore colours and textures through finger painting, encouraging creative expression.",playType:"organised",developmentalFocus:["motor","cognitive","emotional"],isCultural:!1,materials:["Non-toxic finger paints","Large paper","Smocks or old shirts","Water for cleaning"],instructions:["Cover work area with protective covering","Give each child paper and paint","Demonstrate finger painting techniques","Allow free exploration and creativity","Display finished artwork to build confidence"],ageRange:"1-4 years",duration:20},{id:"o3",name:"Building Blocks Play",description:"Develop spatial awareness and problem-solving through block building.",playType:"organised",developmentalFocus:["cognitive","motor","social"],isCultural:!1,materials:["Large soft blocks","Play mat"],instructions:["Set out blocks on play mat","Demonstrate stacking and building","Encourage children to build towers","Facilitate sharing and taking turns","Celebrate creations before cleanup"],ageRange:"1-4 years",duration:15},{id:"o4",name:"Singing and Action Songs",description:"Combine music with movement to develop coordination and language.",playType:"organised",developmentalFocus:["motor","speech","social"],isCultural:!1,materials:["Song list","Musical instruments (optional)"],instructions:["Choose age-appropriate action songs","Demonstrate the actions clearly","Sing slowly at first","Encourage all children to participate","Repeat favourite songs"],ageRange:"0-4 years",duration:10},{id:"o5",name:"Playdough Creations",description:"Strengthen hand muscles and encourage creativity with playdough.",playType:"organised",developmentalFocus:["motor","cognitive","emotional"],isCultural:!1,materials:["Playdough","Cookie cutters","Rolling pins","Play mat"],instructions:["Give each child a ball of playdough","Show rolling, squashing, cutting techniques","Provide tools for exploration","Encourage children to describe what they're making","Allow free creative play"],ageRange:"2-4 years",duration:20},{id:"n1",name:"Nature Exploration Walk",description:"Explore the outdoor environment and collect natural treasures.",playType:"nature",developmentalFocus:["cognitive","speech","motor"],isCultural:!1,materials:["Small buckets or bags","Safe outdoor area"],instructions:["Walk together in a safe outdoor space","Point out interesting natural objects","Let children collect leaves, sticks, shells","Talk about what they find","Return to discuss and sort collections"],ageRange:"2-4 years",duration:20},{id:"n2",name:"Sand and Water Play",description:"Sensory exploration with sand and water builds cognitive and motor skills.",playType:"nature",developmentalFocus:["cognitive","motor","social"],isCultural:!1,materials:["Sand tray or sandbox","Water","Cups, scoops, containers"],instructions:["Set up sand and water play area","Provide various containers and tools","Allow free exploration","Facilitate sharing of tools","Supervise water play closely"],ageRange:"1-4 years",duration:25},{id:"n3",name:"Outdoor Free Play",description:"Unstructured play in a natural environment supports all areas of development.",playType:"nature",developmentalFocus:["motor","social","emotional"],isCultural:!1,materials:["Safe outdoor space","Balls","Bubbles (optional)"],instructions:["Ensure play area is safe","Allow children to explore freely","Observe and facilitate social interactions","Intervene only when necessary for safety","Encourage imaginative play"],ageRange:"0-4 years",duration:30},{id:"p1",name:"Picture Book Corner",description:"Individual book exploration in a cosy reading area develops language and imagination.",playType:"parallel",developmentalFocus:["cognitive","speech","emotional"],isCultural:!1,materials:["Variety of picture books","Cushions","Quiet corner"],instructions:["Set up comfortable reading area","Provide basket of age-appropriate books","Allow children to choose their own books","Read quietly nearby","Children may play alongside each other"],ageRange:"0-4 years",duration:15},{id:"p2",name:"Puzzle Play",description:"Individual puzzle solving with peers nearby builds problem-solving and fine motor skills.",playType:"parallel",developmentalFocus:["cognitive","motor"],isCultural:!1,materials:["Age-appropriate puzzles","Play mat"],instructions:["Set out various puzzles on mat","Allow children to choose their own puzzle","Children work independently but near others","Offer help only if child becomes frustrated","Celebrate completed puzzles"],ageRange:"2-4 years",duration:15},{id:"p3",name:"Colouring Station",description:"Individual colouring with shared materials develops fine motor skills and creativity.",playType:"parallel",developmentalFocus:["motor","cognitive","emotional"],isCultural:!1,materials:["Colouring sheets","Crayons","Table or floor space"],instructions:["Set up colouring area with materials","Provide each child with paper","Share crayons in the middle","Children colour independently","Encourage but don't force sharing"],ageRange:"2-4 years",duration:20}],b={parallel:"Parallel Play",nature:"Nature / Free Play",organised:"Organised Play"},w={social:"Social Skills",emotional:"Emotional Skills",cognitive:"Cognitive Skills",motor:"Motor Skills",speech:"Speech & Language"};let o={search:"",playType:"all",focus:"all",culturalOnly:!1},v=null;function F(e){v?P(e,v):y(e)}function y(e){const i=h.filter(a=>{const s=a.name.toLowerCase().includes(o.search.toLowerCase())||a.description.toLowerCase().includes(o.search.toLowerCase()),l=o.playType==="all"||a.playType===o.playType,r=o.focus==="all"||a.developmentalFocus.includes(o.focus),u=!o.culturalOnly||a.isCultural;return s&&l&&r&&u});e.innerHTML=`
    ...
    <div class="filter-row">
      ...
      ${Object.entries(b).map(([a,s])=>`<button class="filter-btn ${o.playType===a?"active":""}" data-filter="playType" data-value="${a}">${s}</button>`).join("")}
    </div>
    <div class="filter-row">
      <button class="filter-btn ${o.focus==="all"?"active":""}" data-filter="focus" data-value="all">All Skills</button>
      ${Object.entries(w).map(([a,s])=>`<button class="filter-btn ${o.focus===a?"active":""}" data-filter="focus" data-value="${a}">${s}</button>`).join("")}
    </div>
    <div class="filter-row">
      <button class="filter-btn ${o.culturalOnly?"active":""}" data-filter="cultural" data-value="toggle">🌺 Cultural Activities Only</button>
    </div>
      ...
      ${i.map(a=>`
        <div class="activity-card ${a.isCultural?"cultural":""}" data-id="${a.id}">
          ...
          <div class="activity-tags">
            <span class="tag tag-type">${b[a.playType]}</span>
  ...
  `;const t=e.querySelector("#search-input");t==null||t.addEventListener("input",a=>{o.search=a.target.value,y(e)}),e.querySelectorAll("[data-filter]").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-filter"),l=a.getAttribute("data-value");s==="playType"?o.playType=l:s==="focus"?o.focus=l:s==="cultural"&&(o.culturalOnly=!o.culturalOnly),y(e)})}),e.querySelectorAll("[data-id]").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id");v=h.find(l=>l.id===s)||null,v&&P(e,v)})})}function P(e,i){var t;e.innerHTML=`
    ...
    <div class="detail-meta">
      <span class="tag tag-type">${b[i.playType]}</span>
    ...
    <div class="detail-grid">
      <div class="card">
        ...
        <div class="focus-tags">
          ${i.developmentalFocus.map(a=>`<span class="tag tag-focus">${w[a]}</span>`).join("")}
        </div>
      </div>
      <div class="card">
  ...
  `,(t=e.querySelector("#back-btn"))==null||t.addEventListener("click",()=>{v=null,y(e)})}const $="mipla_plans";let d=[],n=null,c="list",g="start";function q(){try{d=JSON.parse(localStorage.getItem($)||"[]")}catch{d=[]}}function E(){localStorage.setItem($,JSON.stringify(d))}function p(e){q(),c==="list"?M(e):c==="edit"?C(e):c==="view"?R(e):c==="pick"&&I(e)}function M(e){var i;e.innerHTML=`
  ...
  `,(a=e.querySelector("#cancel-btn"))==null||a.addEventListener("click",()=>{c="list",n=null,p(e)}),e.querySelectorAll("[data-add]").forEach(l=>{l.addEventListener("click",()=>{g=l.getAttribute("data-add"),c="pick",p(e)})}),e.querySelectorAll("[data-remove]").forEach(l=>{l.addEventListener("click",()=>{const r=l.getAttribute("data-remove"),u=parseInt(l.getAttribute("data-index")||"0");f(n,r).splice(u,1),C(e)})}),(s=e.querySelector("#save-btn"))==null||s.addEventListener("click",()=>{const l=d.findIndex(r=>r.id===n.id);l>=0?d[l]=n:d.push(n),E(),alert("Session plan saved!"),c="list",n=null,p(e)})}function R(e){var a,s,l;if(!n)return;const i=[...n.start,...n.middle,...n.end].reduce((r,u)=>r+u.duration,0),t=(r,u)=>u.length===0?"":`
    <div class="view-section">
      <h4>${r}</h4>
      ${u.map(m=>`<div class="view-activity"><strong>${m.name}</strong> <span>(${m.duration} min)</span></div>`).join("")}
    </div>`;e.innerHTML=`
  ...
  `,(i=e.querySelector("#back-btn"))==null||i.addEventListener("click",()=>{c="edit",p(e)}),e.querySelectorAll("[data-id]").forEach(t=>{t.addEventListener("click",()=>{const a=h.find(s=>s.id===t.getAttribute("data-id"));a&&n&&(f(n,g).push(a),c="edit",p(e))})})}function T(e){document.querySelectorAll(".nav-btn").forEach(t=>{t.classList.remove("active"),t.getAttribute("data-page")===e&&t.classList.add("active")});const i=document.getElementById("content");if(i){switch(e){case"home":S(i);break;case"learn":A(i);break;case"toolkit":x(i);break;case"activities":F(i);break;case"planner":p(i);break}window.scrollTo({top:0,behavior:"smooth"})}}document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{const i=e.getAttribute("data-page");i&&T(i)})}),S(document.getElementById("content"))});
