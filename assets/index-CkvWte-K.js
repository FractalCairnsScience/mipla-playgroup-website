(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(s){if(s.ep)return;s.ep=!0;const l=t(s);fetch(s.href,l)}})();function S(e){e.innerHTML=`
    <div class="hero">
      <img src="/images/photos/playgroup-session.webp" alt="Children playing at playgroup on Thursday Island" class="hero-img" />
      <div class="hero-text">
    ...
    <div class="photo-strip">
      <img src="/images/photos/child-drawing.png" alt="Child drawing at playgroup" class="strip-photo" />
      <img src="/images/photos/child-playing.png" alt="Child at playgroup" class="strip-photo" />
      <img src="/images/photos/weaving-activity.jpg" alt="Traditional weaving activity" class="strip-photo" />
      <img src="/images/photos/children-tunnel.webp" alt="Children playing with tunnel" class="strip-photo" />
    </div>
    ...
    <div class="accordion">
      <div class="acc-item open">
        ...
        <div class="acc-body">
          ...
          <img src="/images/photos/playgroup-session.webp" alt="Playgroup session on Thursday Island" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/photos/child-playing.png" alt="Child playing at Thursday Island playgroup" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/photos/playgroup-session.webp" alt="Community playgroup session on Thursday Island" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/photos/weaving-activity.jpg" alt="Traditional weaving activity at playgroup" class="content-img" />
        </div>
      </div>
      ...
      <div class="acc-item">
        ...
        <div class="acc-body" style="display:none">
          ...
          <img src="/images/photos/children-tunnel.webp" alt="Children playing together at playgroup" class="content-img" />
        </div>
      </div>
    </div>
  ...
  `,(t=e.querySelector("#back-btn"))==null||t.addEventListener("click",()=>{v=null,y(e)})}const C="mipla_plans";let d=[],n=null,c="list",m="start";function q(){try{d=JSON.parse(localStorage.getItem(C)||"[]")}catch{d=[]}}function $(){localStorage.setItem(C,JSON.stringify(d))}function p(e){q(),c==="list"?M(e):c==="edit"?E(e):c==="view"?I(e):c==="pick"&&R(e)}function M(e){var i;e.innerHTML=`
  ...
  `,(a=e.querySelector("#cancel-btn"))==null||a.addEventListener("click",()=>{c="list",n=null,p(e)}),e.querySelectorAll("[data-add]").forEach(l=>{l.addEventListener("click",()=>{m=l.getAttribute("data-add"),c="pick",p(e)})}),e.querySelectorAll("[data-remove]").forEach(l=>{l.addEventListener("click",()=>{const r=l.getAttribute("data-remove"),u=parseInt(l.getAttribute("data-index")||"0");f(n,r).splice(u,1),E(e)})}),(s=e.querySelector("#save-btn"))==null||s.addEventListener("click",()=>{const l=d.findIndex(r=>r.id===n.id);l>=0?d[l]=n:d.push(n),$(),alert("Session plan saved!"),c="list",n=null,p(e)})}function I(e){var a,s,l;if(!n)return;const i=[...n.start,...n.middle,...n.end].reduce((r,u)=>r+u.duration,0),t=(r,u)=>u.length===0?"":`
